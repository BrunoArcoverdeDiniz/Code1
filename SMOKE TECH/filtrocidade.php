...
<?php
	...
	FROM cadastro WHERE cidade ='$cidade' ORDER BY nome";
	...
	$query="
	SELECT nome, sobrenome, cpf, telefone, email, endereco, cep, cidade, estado, pedido
	FROM cadastro WHERE cidade ='$cidade' ORDER BY nome LIMIT $ini,$tamanhopag";
	$recordset = mysql_query($query, $conn);
...
if($paginas > 1)
{
	for($k=1;$k<=$paginas;$k++)
	{
		print "<a href='filtrocidade.php?pag=$k&cidade=$cidade'style='color: white'><b>$k</b></a> ;&nbsp;";
	}
}			
?>
</div>
